...
3. Enter the following adress in the **'Additional board Manager URLs'** : **https://raw.githubusercontent.com/CircuitMess/CircuitMess-Ringo-Arduino-packages/master/package_CircuitMess_Ringo_index.jsonn**. Then click **OK**.
